...
namespace IngameScript
{
    public class Program : MyGridProgram
    {
        ...
        PISTON_HORIZONTAL_GROUP_TAG = "pit horizontal pistons"
        PISTON_VERTICAL_DOWN_GROUP_TAG = "pit vertical pistons down"
        PISTON_VERTICAL_UP_GROUP_TAG = "pit vertical pistons up"
        ...
        // this should really be like a list of states from start to end
        bool isIdle = true;
        bool isMoving = false;
